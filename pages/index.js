...
// import OrigamiIcon from '@/components/MissingIcon'; // TODO: Create the missing file/component 'MissingIcon' at '@/components/MissingIcon'

// Commented out the unused import to fix the error
// gsap.registerPlugin(ScrollTrigger);

export default function LandingPage() {
  const heroRef = useRef(null); // Fixed by adding usage of useRef
